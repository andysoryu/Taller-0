...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("2. Consultar los atletas de un a�o dado");
		System.out.println("3. Consultar las medallas de un atleta en un periodo");
		System.out.println("4. Consultar los atletas de un pa�s dado");
		...
		System.out.println("13. Consultar el pa�s representado por un atleta");
	...
	/**
	 * Le pide al usuario el nombre de un atleta y luego le informa cu�l es el 
	 * pa�s de ese atleta.
	 */
	...
	private void ejecutarPaisdeAtleta()
	{
		...
		String pais = calculadora.buscarAtletaPais(atleta).darNombre();
		System.out.println("El pa�s del atleta es: " + pais);
